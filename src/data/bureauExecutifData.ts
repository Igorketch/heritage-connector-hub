  ...
  fr: [
    ...
    },
    {
      ...
      bio: [
        ...
        "Titulaire d'un Master en traduction Français/Anglais, elle possède une solide expertise en communication, en gestion administrative et en appui aux hautes instances décisionnelles. Son parcours professionnel inclut des fonctions clés au sein de la fonction publique Camerounaise, où elle a assuré la coordination administrative et la traduction de documents stratégiques pour des partenaires internationaux tels que l'OMS et l'UNICEF. Elle a également occupé des postes d'assistante exécutive et d'assistante de direction dans le secteur privé, où elle s'est distinguée par sa capacité à optimiser les processus, réduire les coûts et améliorer la performance organisationnelle.",
